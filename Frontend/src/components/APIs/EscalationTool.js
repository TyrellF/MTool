...
const EscalationTool = () => {
    ...
    const fetchApiStatus = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3005/api/Escalation%20Tool/status"
          // "http://mtool-env.eba-iaphq2wi.eu-west-1.elasticbeanstalk.com:3005/api/Escalation%20Tool/status"
        );
  ...
  return (
    <div className="apiContent">
      <h3 style={{ textAlign: "center", fontSize: "22px" }}>Escalation Tool</h3>
                                  ...
                                  <Tooltip
                                    ...
                                    color={
                                      apiStatus[subAPI].startsWith(
                                        ...
                                        ? "success" // Green for Operational
                                        : "danger" // Red for Downtime
                                    }
                                  >
                                    <Button
