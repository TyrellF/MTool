...
const MFeeds = () => {
    ...
    const fetchApiStatus = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3005/api/MFeeds/status"
          // "http://mtool-env.eba-iaphq2wi.eu-west-1.elasticbeanstalk.com:3005/api/MFeeds/status"
        );
  ...
  return (
    <div className="apiContent">
      <h3 style={{ textAlign: "center", fontSize: "22px" }}>MFeeds API</h3>
