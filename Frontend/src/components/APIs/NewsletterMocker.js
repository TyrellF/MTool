    ...
    const fetchApiStatus = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3005/api/Newsletter%20Mocker/status"
          // "http://mtool-env.eba-iaphq2wi.eu-west-1.elasticbeanstalk.com:3005/api/Newsletter%20Mocker/status"
        );
...
export default NewsletterMocker;
